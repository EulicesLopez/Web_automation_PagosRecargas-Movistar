...
public class CallerJSON_MiMovistarRecarga {
    ...
    public static void API_API_TEST_recargas() throws Throwable {
        try {
    ...
    private static String blockIP(String ip) throws Throwable {
        ...
        entity.append("\"payload\": {\n" +
                "        \"msisdn\": \"51920957944\"\n" +           //51920957944 tarjeta           //51920957944 normal
                "    }");
        entity.append("}");
